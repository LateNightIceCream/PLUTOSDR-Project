...
SP.FrameSize       = (SP.HeaderLength + SP.SizeFieldLength + SP.PayloadLength + numel(calc_padding_bits(SP.HeaderLength + SP.SizeFieldLength + SP.PayloadLength, SP.ModulationOrder))) ...
